...
alter table challenges add constraint fk_challenges_invteam foreign key (invteam) references teams (tid) on delete restrict on update restrict;
create index ix_challenges_invteam on challenges (invteam);

alter table challenges add constraint fk_challenges_chteam foreign key (chteam) references teams (tid) on delete restrict on update restrict;
create index ix_challenges_chteam on challenges (chteam);
...
alter table challenges drop foreign key fk_challenges_invteam;
drop index ix_challenges_invteam on challenges;

alter table challenges drop foreign key fk_challenges_chteam;
drop index ix_challenges_chteam on challenges;
