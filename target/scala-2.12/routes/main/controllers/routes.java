...
public class routes {
  ...
  public static final controllers.ReversePlayGroundController PlayGroundController = new controllers.ReversePlayGroundController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReversePlayGroundController PlayGroundController = new controllers.javascript.ReversePlayGroundController(RoutesPrefix.byNamePrefix());
